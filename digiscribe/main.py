...
st.set_page_config(page_title="DigiScribe- Handwritten Notes Transcription", layout="wide", initial_sidebar_state="expanded")
...
logo_path = "images/Hackathon_logo.jpg"  # Ensure this file is in the working directory

# Create layout with two columns
col1, col2 = st.columns([0.3, 3.5])  # Adjust width ratios as needed
